...
|--------|---------|-------------|---------|---------|
| `.widget` | 37次 | 297, 384, 464, 9163, 9169, 9312, 9396, 9731 | 完全重复+版本叠加 | ⚠️ 高 |
| `.weather-widget` | 66次 | 899, 1009, 1065+ | 伪元素+hover+嵌套 | ⚠️ 高 |
| `.quick-switch-item` | 68次 | 697, 4084, 7167+ | 状态+动画+嵌套 | ⚠️ 高 |
| `.top-status-bar` | 9次 | 6, 1257, 4839, 5489, 9685, 10296 | 完全重复定义 | ⚠️ 中 |
