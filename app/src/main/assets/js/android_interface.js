...
(function() {
    ...
    window.Android = {
        ...
        setMaxCooling: function(on) { console.log('[Mock] setMaxCooling:', on); return true; },

        // ---------- 车控功能 ----------
        getCarState: function() { return JSON.stringify(generateMockCarState()); },
        setLowBeamLight: function(on) { console.log('[Mock] setLowBeamLight:', on); return true; },
        setRearFogLight: function(on) { console.log('[Mock] setRearFogLight:', on); return true; },
        setPositionLight: function(on) { console.log('[Mock] setPositionLight:', on); return true; },
        setPedestrianAlert: function(on) { console.log('[Mock] setPedestrianAlert:', on); return true; },
        setNightMode: function(on) { console.log('[Mock] setNightMode:', on); return true; },
        ...
        setWifiEnabled: function(on) { console.log('[Mock] setWifiEnabled:', on); return true; },
        setBluetoothEnabled: function(on) { console.log('[Mock] setBluetoothEnabled:', on); return true; },
