...
class TestCheckCommitMsg:
    ...
    def test_invalid_type(self):
        ...
        assert 'type' in result['errors'][0].lower() or '类型' in result['errors'][0]
    ...
    def test_subject_too_long_warning(self):
        ...
        assert result['valid'] == True  # 警告不影响有效性
...
支持多行"""
    ...
    def test_all_types(self):
        ...
        for t in valid_types:
            ...
            assert result['valid'] == True, f"{t} 类型应该合法"
